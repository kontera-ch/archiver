...
describe('ProofGenerator - PtHangz2', () => {
  ...
  const block = JSON.parse(fs.readFileSync('./testing/data/PtHangz2/blockResponse.json', 'utf8'));
  ...
  test('buildBlockHashProof', async () => {
    const blockHashProof = JSON.parse(fs.readFileSync('./testing/data/PtHangz2/blockHashProof.json', 'utf8'));
